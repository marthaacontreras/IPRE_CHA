...
Census_Zip <- rbind(Census_Zip_2019, Census_Zip_2020, Census_Zip_2021, Census_Zip_2022, Census_Zip_2023) %>% 
  ...
  rename(date = quarter) %>% 
  select(date, zip_codes, program_label, total_units, pct_reported, people_per_unit, rent_per_month, hh_income, pct_disabled_all, pct_age62plus, pct_minority) %>% 
 
   # Ensure zip_codes are treated as characters, not numbers
